...
namespace DataFilterGenericLibrary
{
    ...
    #region Discrete Meyer
    public class Dmey
    {
        public static Wavelet dmey_init(bool centered)
        {
            Wavelet wavelet = new Wavelet();
        ...
        public static double[] g_ = new double[]
        {
                    0.0,
        ...
        public static double[] h_ = new double[]
        {
            1.009999956941423e-12,
            8.519459636796214e-09,
            1.111944952595278e-08,
